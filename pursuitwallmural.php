...
<head>
    ...
    <title>Custom Printed Large Wall Mural Wrap Pursuit Church Denver NC | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/pursuitwallmural/alt/pursuitwallmural3.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Pursuit Church Wall Mural</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Printed Wall Mural</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/pursuitwallmural/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/pursuitwallmural/alt/pursuitwallmural5.jpg" alt="">
