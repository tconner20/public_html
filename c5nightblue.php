...
<head>
    ...
    <title>C5 Corvette Custom Wrap Denver NC Lake Norman Charlotte | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/c5nightblue/alt/c5nightblueh.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>C5 Z06 Corvette</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Hexis Night Blue Metallic</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/c5nightblue/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/c5nightblue/c5nightblue7.jpg" alt="">
