...
<head>
    ...
    <title>Custom Sprinter Wrap Hoodsly Satin Black | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/hoodslyblackvan/hoodslyblackvan2.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Satin Black Hoodsly Sprinter</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Satin Black Wrap with Gloss Overlays</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/hoodslyblackvan/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/hoodslyblackvan/alt/hoodslyblackvan10.jpg" alt="">
