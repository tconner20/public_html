...
<head>
    ...
    <title>Brancer Homes Commercial Wrap Ford Escape | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/brancer-homes-escape/alt/brancerhomes-escape1h.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Brancer Homes Escape</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/brancer-homes-escape/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/brancer-homes-escape/alt/brancerhomes-escape9b.jpg" alt="">
