...
<head>
    ...
    <title>HydroHelp911 Ford Ranger Custom Wrap | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/hhranger/alt/hhranger1.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>HydroHelp911 Ford Ranger</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/hhranger/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/hhranger/alt/hhranger8.jpg" alt="">
