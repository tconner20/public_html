...
<head>
    ...
    <title>HyrdoHelp911 Ford Transit Custom Wrap | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/hhtransit/alt/hhtransit5.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>HydroHelp911 Ford Transit</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/hhtransit/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/hhtransit/alt/hhtransit1.jpg" alt="">
