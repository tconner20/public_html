...
<head>
    ...
    <title>Cybertruck Cyberbeast Custom Wrap Charlotte NC Denver NC Lake Norman | Testament Graphic House</title>
    ...
    <meta name="keywords" content="Custom Vehicle Wraps Denver NC, Custom Vehicle Wraps LKN, Chrome Deletes Denver NC, Commercial Wraps Denver NC, Custom Graphics Denver NC, Cybertruck wraps near denver nc lakenorman area">
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/cyberbeast/alt/cyberbeast3.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Cybertruck Cyberbeast</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Full Wrap in Hexis Matte Wasabi</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/cyberbeast/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/cyberbeast/alt/cyberbeast9.jpg" alt="">
