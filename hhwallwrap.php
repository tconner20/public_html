...
<head>
    ...
    <title>Custom Printed Wall Wrap HydroHelp911 HQ | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/hhwallwrap/alt/hhwallwrap0.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>HydroHelp911 HQ Wall Wrap</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Printed Wall Wrap</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/hhwallwrap/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/hhwallwrap/alt/hhwallwrap2.jpg" alt="">
