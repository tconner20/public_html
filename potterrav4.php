...
<head>
    ...
    <title>Custom Printed Commercial Wrap Potter Automotive Rav4 | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/potterrav4/potterrav47.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Potter Automotive Rav4</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/potterrav4/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/potterrav4/alt/potterrav43.jpg" alt="">
