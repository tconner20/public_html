...
<head>
    ...
    <title>Tesla Wrapped in Cosmetic PPF SVG Custom Wrap | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/teslappf/alt/teslappf6.jpg" height="500" style="object-position: 0 77%;" alt="">
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Full Wrap in SVG Cosmetic PPF</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/teslappf/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/teslappf/alt/teslappf1.jpg" alt="">
