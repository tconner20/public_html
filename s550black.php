...
<head>
    ...
    <title>Luxury Colorchange Wrap on Mercedes S500 | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/s550black/alt/s550black8.jpg" height="500" style="object-position: 0 77%;" alt="">
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Wrapped in KPMF Matte Phantom Black</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/s550black/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/s550black/alt/s550black5.jpg" alt="">
