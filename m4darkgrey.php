...
<head>
    ...
    <title>Custom Colorchange Wrap on G82 BMW M4 | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/m4darkgrey/alt/m4darkgrey3.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>G82 M4 in Satin Dark Grey</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Colorchange Wrap in Avery Satin Dark Grey</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/m4darkgrey/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/m4darkgrey/alt/m4darkgrey7.jpg" alt="">
