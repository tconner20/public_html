...
<head>
    ...
    <title>Advertising Truck Wrap for High Vision Tree Services | Testament Graphic House</title>
    <meta name="description" content="Check out this recent project. Designed, Printed and Installed by Testament Graphic House. Custom Advertising Truck Wraps Charlotte NC">
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/highvisiontruck/alt/highvisiontruckh.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Custom Advertising Truck Wrap</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Printed Truck Wrap for High Vision Tree Services</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/highvisiontruck/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/highvisiontruck/alt/highvisiontruckb.jpg" alt="">
