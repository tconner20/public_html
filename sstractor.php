...
<head>
    ...
    <title>Custom Graphic Wrap Boxtruck Commercial Wrap Denver NC | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/sstractor/alt/sstractor5.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>S&S Tractor Repair Boxtruck</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Printed Commercial Boxtruck Wrap</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/sstractor/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/sstractor/alt/sstractor4.jpg" alt="">
