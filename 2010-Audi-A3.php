...
<head>
    ...
    <title>2010 Audi A3 | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/Audi-A3/audia3wrap18.jpg" height="500" style="object-position: 0 77%;" alt="">
        <div class="banner-content">
            <h1>Shop Car V1 Audi A3</h1>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Wrap in Matte White with Custom Gloss Metallic Overlays</h2>
            </div>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/Audi-A3/';
    ...
    <div class="contact-us">
        <div class="contact-us-item">
            <h2>Contact Us</h2>
            <p>Contact us today to get started on a Testament to your business!</p>
