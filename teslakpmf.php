...
<head>
    ...
    <title>Tesla Model Y Custom Colorchange Wrap Denver NC | Testament Graphic House</title>
...
<body>
    ...
    <div class="banner">
        <img src="assets/images/teslakpmf/teslakpmf1.jpg" height="500" style="object-position: 0 77%;" alt="">
    ...
    <div class="container">
        ...
        <div class="title">
            <h2>Custom Colorchange Wrap in KPMF Gloss Hypnotic Black Violet</h2>
        ...
        <div class="project-gallery">
            ...
            <?php
            $directory = 'assets/images/teslakpmf/';
    ...
    <div class="contact-us">
        ...
        <div class="contact-us-image">
            <img src="assets/images/teslakpmf/teslakpmf2.jpg" alt="">
